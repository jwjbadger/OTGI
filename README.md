...
The stored diagnostic's codes (DTC) are probed on startup though they are not currently sent over BLE (this is the next step in the construction of this project). 
